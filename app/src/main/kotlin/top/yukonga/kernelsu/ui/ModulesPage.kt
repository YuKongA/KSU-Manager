...
import top.yukonga.kernelsu.ui.component.ModuleCard
                ...
                item {
                    for (i in 0 until ii.intValue) {
                        ModuleCard(
                            ...
                            version = "1.0.0",
                            author = "Author",
                            description = "This is a description of the module. It provides various functionalities and features that enhance the user experience.",
                            enable = remember { mutableStateOf(false) },
                            onDelete = { /* TODO: Handle delete action */ },
                            onRun = { /* TODO: Handle run action */ },
